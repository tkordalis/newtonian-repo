...
Mesh_1.Segment(geom=rightPlane).StartEndLength ( Element_size_on_Ambient, Element_size_on_Ambient )
...
SymmetryB2out_mesh_distribution = Mesh_1.Segment(geom=SymmetryB2out).NumberOfSegments(NumSegmentsOnAmbient)
SymmetryB2out_mesh_distribution.SetExpressionFunction(NodeDensityFunction_Sym)
# Bubble1_line_mesh_distribution.SetReversedEdges( idBubble1 )
