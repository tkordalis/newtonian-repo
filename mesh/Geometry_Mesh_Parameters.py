...
endLengthOnSurroundings   = 5*edgeSizeOnInflatedBubble

minSquareElementLength = 1.8*startLengthOnSurroundings
maxSquareElementLength = 1.8*startLengthOnSurroundings
