    Function int_n_dot_UmUmesh( NELEM, NED ) Result(TEMP_RES)
        ...
        LOOP_GAUSS: DO KK = 1, NGAUSS_1d
            ...
            TERM_1  = TERM_1 + ( ( nR*(Vr-dRdt) + nZ*(Vz-dZdt) ) * C ) * (R*WET)
    ...
    End Function int_n_dot_UmUmesh

! ********************************************************************

    Function int_n_dot_UbubblemUmesh( NELEM, NED ) Result(TEMP_RES)
        use time_integration, only:dt, time
        ...
        LOOP_GAUSS: DO KK = 1, NGAUSS_1d
            ...
            TERM_1  = TERM_1 + ( ( nZ*(velocity_bubble-dZdt) + nR*( -dRdt) ) * mol_bubble/volume_bubble ) * (R*WET)
    ...
    End Function int_n_dot_UbubblemUmesh
...
! ********************************************************************
    ...
    Function int_n_dot_gradC( NELEM, NED ) Result(TEMP_RES)
        ...
        LOOP_GAUSS: DO KK = 1, NGAUSS_1d
            ...
            TERM_1  = TERM_1 + ( (nR*dCdR + nZ*dCdZ)/PeN ) * (R*WET)
