...
Module BulkEquations
  ...
  !---------------------------------------------------------------------
    Subroutine DOMI_RESIDUAL_fluid( NELEM, TEMP_TL, TEMP_RES, STORE )
        ...
        Real(8)  :: BIFN, SBFN
        Real(8)  :: Helem, Uelem, Ha, tlsme, tlsmt, hugn
        ...
        Real(8), Dimension(NCD)      :: gradq, gradk, gradm, momentum_equation, elliptic_grid

        Real(8), Dimension(NBF_2d)             :: P_, C_, Co_
        Real(8), Dimension(NCD,NBF_2d)         :: X_, Xo_, dXdt_, X0_, U_, Uo_, dPdX_, dCdX_, dBFNdX_, gradq_, gradk_, gradm_
        ...
        C_ = TEMP_TL(:,getVariableId("C"))       ;  Co_ = TLo_loc(:,getVariableId("C"))  
        ...
        LOOP_GAUSS: DO KK = 1, NGAUSS_2d
            ...
            call basis_interp_scalar ( C_  , KK, X_ , Cgp , dCgpdX )
            ...
            call FEMinterpolation(Co_, BFN(:), Cogp )
